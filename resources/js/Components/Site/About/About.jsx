        ...
        <section id="about" className="flex flex-col justify-between h-auto mx-auto mt-44 p-5 overflow-hidden">
            <div className="max-w-[1240px] mx-auto">
                ...
                <div
                    ...
                    <img src={image11} alt="Image 1"  className="h-auto w-[620px] xl:max-w-[1000px] lg:max-w-[1000px] xl:left-0 lg:relative lg:left-[-120px] sm:max-w-[1000px] md:max-w-[1300px] object-cover md:ml-[-14px] sm:ml-[-34px] xs:ml-[-50px]" />
