...
return [
    "tattoo_idea.required" => "La tua idea per il tatuaggio è fondamentale per darti un preventivo corretto!",
    "tattoo_idea.min" => "Cerca di descrivere la tua idea in almeno 30 caratteri.",
    "references.required" => "Parlami delle tue referenze! Link, immagini, tutto va bene...",
    "size.required" => "Conoscere la dimensione del tatuaggio è importante perché influisce sul prezzo.",
